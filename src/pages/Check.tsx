import Index from "../components/Check/index.tsx";
import ConnectWallet from "../components/Metamask/ConnectWallet.tsx";

export default function Check(): JSX.Element {
	return (
		<div className="flex justify-center items-center">
			<div className="pb-7 max-w-[1000px]">
				<ConnectWallet isGoBack={true} />
				<div className="px-5 pt-5">
					<h1 className="text-4xl font-bold dark:text-black pb-3">
						Two steps to boosted
						SKY rewards
					</h1>
